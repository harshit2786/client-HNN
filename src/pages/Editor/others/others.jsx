...
function EditorOthers() {
  ...
  useEffect(() => {
    const fetchNotes = async () => {
      try {
        ...
        const response = await getOneTypeBlog("drafts", "Other");
  ...
  return (
    <div className="h-screen bg-[#fdf7f3] flex flex-col gap-8 items-center justify-center">
        ...
        <ModalContent>
          ...
          <ModalBody>
            <p className=" text-xs text-[#BF7B67] ">
              {" "}
              Type "DELETE" to permanently delete this item.
            </p>
            <Input
              value={input}
              size="sm"
      ...
      <div className="bg-[#FAE9DD] h-[300px] border flex justify-center rounded-lg w-[80%] border-[#BF7B67] overflow-y-auto">
            ...
            {filterStories?.map((item) => (
              <TableRow>
                ...
                <TableCell>
                  <Button
                    onClick={() =>
                      navigate(`/editor/others/${item?.attributes?.Path}`)
                    }
                    size="sm"
                    isIconOnly
                    variant="flat"
              ...
              <TableRow>
                ...
                <TableCell>
                  <Button
                    onClick={() =>
                      navigate(
                        `/editor/others/draft/${item?.attributes?.Path}`
                      )
                    }
                    size="sm"
                    isIconOnly
