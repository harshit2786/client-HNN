  ...
  useEffect(() => {
    const fetchNotes = async () => {
      try {
        ...
        const response = await getOneTypeBlog("drafts", "Story");
        ...
        <ModalContent>
          ...
          <ModalBody>
            <p className=" text-xs text-[#BF7B67] ">
              {" "}
              Type "DELETE" to permanently delete this story.
            </p>
            <Input
              value={input}
              size="sm"
            ...
            {stories?.map((item) => (
              <TableRow>
                ...
                <TableCell>
                  <Button
                    onClick={() =>
                      navigate(`/editor/stories/${item?.attributes?.Path}`)
                    }
                    size="sm"
                    isIconOnly
                    variant="flat"
              ...
              <TableRow>
                ...
                <TableCell>
                  <Button
                    onClick={() =>
                      navigate(
                        `/editor/stories/draft/${item?.attributes?.Path}`
                      )
                    }
                    size="sm"
                    isIconOnly
