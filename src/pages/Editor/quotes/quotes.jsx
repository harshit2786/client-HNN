  ...
  useEffect(() => {
    const fetchNotes = async () => {
      try {
        ...
        const response = await getOneTypeBlog("drafts", "Quote");
        ...
        <ModalContent>
          ...
          <ModalBody>
            <p className=" text-xs text-[#BF7B67] ">
              {" "}
              Type "DELETE" to permanently delete this quote.
            </p>
            <Input
              value={input}
              size="sm"
            ...
            {stories?.map((item) => (
              <TableRow>
                ...
                <TableCell>
                  <Button
                    onClick={() =>
                      navigate(`/editor/quotes/${item?.attributes?.Path}`)
                    }
                    size="sm"
                    isIconOnly
                    variant="flat"
              ...
              <TableRow>
                ...
                <TableCell>
                  <Button
                    onClick={() =>
                      navigate(
                        `/editor/quotes/draft/${item?.attributes?.Path}`
                      )
                    }
                    size="sm"
                    isIconOnly
